                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <a href="" title="Edit" data-toggle="modal" data-toggle="modal" data-target="#updateModal" name="btn-edit" onclick="detail_edit(<?= $item['nik']; ?>)" class="btn btn-sm btn-edit btn-warning"><i class="fa fa-edit"></i></a>
                                                            <a href="" title="Hapus" class="btn btn-sm btn-delete btn-danger" onclick="Hapus(<?= $item['nik']; ?>)" data-toggle="modal" data-target="#deleteModal" data-id="<?= $item['nik']; ?>"><i class="fa fa-trash"></i></a>
                                                        </center>
                                                    </td>
                                                </tr>
                                            <?php } ?>
            ...
            $("#input_email").keyup(function(){
                ...
                if(nama != ''){
                    $.ajax({
                        type: 'GET',
                        dataType: 'json',
                        url: '<?php echo base_url('Karyawan/Pasien/cek_email'); ?>' + '/' + nama,
