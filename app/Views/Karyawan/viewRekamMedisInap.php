                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        <center>
                                                            ...
                                                            <a href="" title="Hapus" class="btn btn-sm btn-delete btn-danger" onclick="Hapus(<?= $item['id_rekam']; ?>)" data-toggle="modal" data-target="#deleteModal" data-id="<?= $item['id_rekam']; ?>"><i class="fa fa-trash"></i></a>
                                                        </center>
                                                    </td>
                                            </tr>
                                            <?php } ?>
