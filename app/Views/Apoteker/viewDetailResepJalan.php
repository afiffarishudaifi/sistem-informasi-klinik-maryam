    ...
    <script>
        ...
        $(function() {
            ...
            $("#input_obat").select2({
                ...
                theme: 'bootstrap4',
                ajax: {
                    url: '<?php echo base_url('Apoteker/RawatJalan/data_obat'); ?>',
                    type: "post",
                    delay: 250,
                    dataType: 'json',
            ...
            $('#input_obat').on('change', function() {
              $.getJSON('<?php echo base_url('Apoteker/RawatJalan/harga_obat'); ?>' + '/' + this.value, {},
                function(json) {
        ...
        function detail_edit(isi) {
            $.getJSON('<?php echo base_url('Apoteker/RawatJalan/data_edit_detail_resep'); ?>' + '/' + isi, {},
                function(json) {
