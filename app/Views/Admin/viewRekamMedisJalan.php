...
<body class="hold-transition sidebar-mini">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        <center>
                                                            <a href="<?= base_url('Admin/RawatJalan/resepJalan'); ?>" class="btn btn-sm btn-edit btn-info" title="Detail"><i class="fa fa-eye"></i></a>
                                                            <a href="" title="Hapus" title="Edit" data-toggle="modal" data-toggle="modal" data-target="#updateModal" name="btn-edit" onclick="detail_edit(<?= $item['id_rekam']; ?>)" class="btn btn-sm btn-edit btn-warning"><i class="fa fa-edit"></i></a>
                                                        </center>
                                                    </td>
                                            </tr>
                                            <?php } ?>
    ...
    <script>
        ...
        $("#input_dokter").select2({
            ...
            theme: 'bootstrap4',
            ajax: {
                url: '<?php echo base_url('Admin/RawatJalan/data_dokter'); ?>',
                type: "post",
                delay: 250,
                dataType: 'json',
                data: function(params) {
        ...
        $("#input_penyakit").select2({
            ...
            theme: 'bootstrap4',
            ajax: {
                url: '<?php echo base_url('Admin/RawatJalan/data_penyakit'); ?>',
                type: "post",
                delay: 250,
                dataType: 'json',
                data: function(params) {
