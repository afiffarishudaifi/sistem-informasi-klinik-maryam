...
class Model_rawatjalan extends Model
{
    ...
    public function view_data()
    {
        ...
        $builder->select('id_pendaftaran, jadwal_dokter.id_jadwal, pasien.nama_pasien, poli.nama_poli, pendaftaran_rawat_jalan.no_antrian, hari.nama_hari, dokter.nama_dokter, pendaftaran_rawat_jalan.status_antrian');
        ...
        $builder->join('poli','pendaftaran_rawat_jalan.id_poli = poli.id_poli');
    ...
    public function detail_data($id)
    {
        $db      = \Config\Database::connect();
        $builder = $db->table('pendaftaran_rawat_jalan');
        $builder->select("id_pendaftaran, jadwal_dokter.id_jadwal, pasien.id_pasien, pasien.nama_pasien, poli.id_poli, pendaftaran_rawat_jalan.keluhan, pendaftaran_rawat_jalan.umur, pendaftaran_rawat_jalan.status_antrian, DATE_FORMAT(pendaftaran_rawat_jalan.tanggal_daftar, '%Y-%m-%dT%H:%i') as tanggal_daftar, poli.nama_poli, pendaftaran_rawat_jalan.no_antrian, hari.nama_hari, dokter.nama_dokter, pendaftaran_rawat_jalan.status_antrian");
        $builder->join('jadwal_dokter','pendaftaran_rawat_jalan.id_jadwal = jadwal_dokter.id_jadwal');
        $builder->join('hari','hari.id_hari = jadwal_dokter.id_hari');
        $builder->join('dokter','dokter.id_dokter = jadwal_dokter.id_dokter');
        $builder->join('poli','pendaftaran_rawat_jalan.id_poli = poli.id_poli');
    ...
    public function view_data_rekam()
    {
        $db      = \Config\Database::connect();
        $builder = $db->table('pendaftaran_rawat_jalan');
        $builder->select('pendaftaran_rawat_jalan.id_pendaftaran, pendaftaran_rawat_jalan.hasil_pemeriksaan, pendaftaran_rawat_jalan.saran_dokter, pendaftaran_rawat_jalan.tensi_darah, pendaftaran_rawat_jalan.id_pendaftaran, pasien.nama_pasien, pendaftaran_rawat_jalan.tanggal_daftar, dokter.nama_dokter, poli.nama_poli');
        $builder->join('jadwal_dokter','pendaftaran_rawat_jalan.id_jadwal = jadwal_dokter.id_jadwal');
        $builder->join('dokter','dokter.id_dokter = jadwal_dokter.id_dokter');
        $builder->join('poli','pendaftaran_rawat_jalan.id_poli = poli.id_poli');
        $builder->join('pasien','pendaftaran_rawat_jalan.id_pasien = pasien.id_pasien');
    ...
    public function view_data_resep()
    {
        $db      = \Config\Database::connect();
        $builder = $db->table('pendaftaran_rawat_jalan');
        $builder->select('pendaftaran_rawat_jalan.id_pendaftaran, sum(detail_resep.total_biaya) as tagihan_obat, pasien.nama_pasien, dokter.nama_dokter, pendaftaran_rawat_jalan.created_at');
        $builder->join('jadwal_dokter','pendaftaran_rawat_jalan.id_jadwal = jadwal_dokter.id_jadwal');
        $builder->join('dokter','dokter.id_dokter = jadwal_dokter.id_dokter');
        $builder->join('pasien','pendaftaran_rawat_jalan.id_pasien = pasien.id_pasien');
        $builder->join('detail_resep', 'pendaftaran_rawat_jalan.id_pendaftaran = detail_resep.id_pendaftaran', 'left');
        $builder->groupBy("pendaftaran_rawat_jalan.id_pendaftaran");
        return $builder->get();
    }
    ...
    public function view_detail_resep($id)
    {
        ...
        $builder->select('detail_resep.id_detail, detail_resep.id_pendaftaran, detail_resep.id_obat, obat.nama_obat, detail_resep.jumlah_obat, detail_resep.total_biaya');
        $builder->join('obat','detail_resep.id_obat = obat.id_obat');
        $builder->where('detail_resep.id_pendaftaran', $id);
        return $builder->get();
    }
    ...
    public function detail_data_detail_resep($id)
    {
        $db      = \Config\Database::connect();
        $builder = $db->table('detail_resep');
        $builder->select('id_detail, detail_resep.id_obat, obat.nama_obat, detail_resep.jumlah_obat, total_biaya, id_pendaftaran');
