...
class RawatJalan extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('Apoteker/viewDaftarRawatJalan', $data);
    }
    ...
    public function add_pendaftaran()
    {
        ...
        return redirect()->to(base_url('Apoteker/RawatJalan'));
    }
    ...
    public function delete_pendaftaran()
    {
        ...
        // }
        return redirect()->to('/Apoteker/RawatJalan');
    }
    ...
    public function rekamJalan()
    {
        ...
        return view('Apoteker/viewRekamMedisJalan', $data);
    }
    ...
    public function add_rekam()
    {
        ...
        $session->setFlashdata('sukses', 'Data sudah berhasil ditambah');
        return redirect()->to(base_url('Apoteker/RawatJalan/rekamJalan'));
    }
    ...
    public function delete_rekam()
    {
        ...
        //     session()->setFlashdata('gagal', 'Data ini dipakai di tabel lain dan tidak bisa dihapus');
        // }
        return redirect()->to('/Apoteker/RawatJalan/rekamJalan');
    }
    ...
    public function resepJalan()
    {
        ...
        return view('Apoteker/viewResepJalan', $data);
    }
    ...
    public function add_resep()
    {
        ...
        $session->setFlashdata('sukses', 'Data sudah berhasil ditambah');
        return redirect()->to(base_url('Apoteker/RawatJalan/resepJalan'));
    }
    ...
    public function delete_resep()
    {
        ...
        //     session()->setFlashdata('gagal', 'Data ini dipakai di tabel lain dan tidak bisa dihapus');
        // }
        return redirect()->to('/Apoteker/RawatJalan/resepJalan');
    }
    ...
    public function detailResep($id)
    {
        ...
        return view('Apoteker/viewDetailResepJalan', $data);
    }
    ...
    public function add_detail_resep()
    {
        ...
        if ($cek_stok['stok_obat'] < $jumlah_obat) {
            ...
            return redirect()->to(base_url('Apoteker/RawatJalan/detailResep' . '/' . $id_pendaftaran));
        }
    ...
    public function delete_detail_resep()
    {
        ...
        session()->setFlashdata('sukses', 'Data sudah berhasil dihapus');
        return redirect()->to('/Apoteker/RawatJalan/detailResep' . '/' . $id_pendaftaran);
    }
